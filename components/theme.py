...
- high readability
- consistent sidebar, cards, forms, inputs and expanders
...
def apply_theme() -> None:
    ...
    st.markdown(
        ...
        [data-testid="stVerticalBlockBorderWrapper"] {
            ...
            border:
                1px solid
                var(--nw-border) !important;

            border-radius:
                var(--nw-radius-md) !important;
        ...
        [data-testid="stTextInput"] input {
            ...
            border:
                1px solid
                var(--nw-border-strong) !important;

            border-radius:
                var(--nw-radius-sm) !important;
        }

        [data-testid="stTextInput"] input:focus {
            border-color:
                var(--nw-accent) !important;
        ...
        [data-testid="stNumberInput"] button {
            background:
                var(--nw-surface-soft) !important;

            color:
                var(--nw-text-secondary) !important;
